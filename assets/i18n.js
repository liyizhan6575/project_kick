...
window.I18N = (function(){
  var DICT = {
    en: {
      ...
      ch3_body_1: "Pitch control, xG, xT — we stand on the best of football science and build on it with our own value models, refined with the right method for each problem. We open-source the field's leading metrics on ",
    ...
    de: {
      ...
      ch3_body_1: "Pitch Control, xG, xT – wir bauen auf dem Besten der Fußballwissenschaft auf und entwickeln es mit eigenen Value-Modellen weiter, für jedes Problem mit der passenden Methode verfeinert. Wir stellen die führenden Metriken des Fachs auf ",
    ...
    es: {
      ...
      ch3_body_1: "Control del terreno, xG, xT —partimos de lo mejor de la ciencia del fútbol y construimos sobre ella con nuestros propios modelos de valor, refinados con el método adecuado para cada problema. Publicamos en código abierto las métricas de referencia del sector en ",
