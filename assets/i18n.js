...
window.I18N = (function(){
  var DICT = {
    en: {
      ...
      ch4_c3_t: "Clubs", ch4_c3_b: "An annotation studio with our models inside. Coaches draw tactics, generate broadcast-grade visuals, and build film sessions that stick.",
    ...
    zh: {
      doc_title: "KICK · 让科学与足球相连",
      nav_cv: "计算机视觉", nav_viz: "可视化", nav_research: "研究", nav_work: "合作",
      hero_slogan: '让<span class="g">科学</span>与足球相连',
      scroll: "向下滚动",
      ch1_eyebrow: "01 · 计算机视觉",
      ch1_head: "直接从视频，读懂比赛",
      ch1_body: "关键点检测、球员分类与追踪——均为我们自主研发、自主训练的原创模型——将转播画面转化为空间数据，无需任何第三方数据源。底层数据集也恪守同样的标准：逐帧标注，一丝不苟。",
      ...
      ch4_c3_t: "俱乐部", ch4_c3_b: "一套内置我们模型的标注工作室。教练可以绘制战术、生成转播级画面，制作出让球员真正记得住的录像分析课。",
