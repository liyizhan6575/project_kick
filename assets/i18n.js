...
window.I18N = (function(){
  var DICT = {
    en: {
      ...
      ch3_body_1: "We stand on the best of football science and build on it with our own value models. We open-source the field's leading metrics on ",
      ch3_body_2: ", and welcome every researcher and practitioner to join.",
    ...
    zh: {
      ...
      ch3_eyebrow: "03 · 研究",
      ch3_head: "这不只是工程项目。",
      ch3_body_1: "我们立足足球科学的前沿成果，并在此基础上构建自研模型。我们在 ",
      ch3_body_2: " 开源该领域领先的指标，也欢迎每一位学者与实践者加入。",
    ...
    de: {
      ...
      ch3_body_1: "Wir bauen auf dem Besten der Fußballwissenschaft auf und entwickeln es mit eigenen Value-Modellen weiter. Wir stellen die führenden Metriken des Fachs auf ",
      ch3_body_2: " als Open Source bereit und laden alle Forschenden und Praktiker ein, mitzuwirken.",
      ...
      ch4_c1_t: "Datenanbieter", ch4_c1_b: "Computer Vision, die Ihre Zahlen aufwertet – schärfere Keypoints, Tracking auch bei Verdeckung, Traces für alle außerhalb des Bildes.",
      ch4_c2_t: "Broadcaster", ch4_c2_b: "Jedes Datenformat rein, fertige Sendung raus: Live-KI-Kommentar, Spieler-Spotlights, Taktik-Analysen und Grafiken – während das Spiel läuft.",
      ch4_c3_t: "Vereine", ch4_c3_b: "Annotationssoftware mit unseren Modellen. Trainer skizzieren Taktik, erzeugen Broadcast-Grafiken und bauen Videoanalysen, die hängen bleiben.",
      ch4_c4_t: "Einzelpersonen", ch4_c4_b: "Fußball ist nicht nur für die Branche. Sie lieben das Spiel und sind in etwas brillant – Musik, Kunst, Code? Schaffen Sie etwas Neues. Bringen Sie die Leidenschaft mit, den Rest finden wir.",
    ...
    es: {
      ...
      ch3_body_1: "Partimos de lo mejor de la ciencia del fútbol y construimos sobre ella con nuestros propios modelos de valor. Publicamos en código abierto las métricas de referencia del sector en ",
      ch3_body_2: ", e invitamos a investigadores y profesionales a sumarse.",
      ...
      ch4_c1_t: "Proveedores de datos", ch4_c1_b: "Visión por computadora que eleva tus cifras: puntos clave más precisos, seguimiento pese a las oclusiones y trayectorias para quienes quedan fuera de cámara.",
      ch4_c2_t: "Emisoras", ch4_c2_b: "Cualquier formato entra, una transmisión terminada sale: narración con IA, jugadores destacados, análisis tácticos y gráficos, mientras sucede el partido.",
      ch4_c3_t: "Clubes", ch4_c3_b: "Software de anotación con nuestros modelos. Los entrenadores dibujan tácticas, generan gráficos de transmisión y crean sesiones de video que dejan huella.",
      ch4_c4_t: "Personas", ch4_c4_b: "El fútbol no es solo para la industria. ¿Amas el juego y destacas en algo —música, arte, código? Ven a crear algo nuevo. Tú pon la pasión; del resto nos encargamos.",
